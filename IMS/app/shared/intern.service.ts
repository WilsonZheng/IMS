...
export class InternService {
    ...
    getTaskHistoryForIntern(internId: number): Promise<TaskInvolvement[]> {
    ...
    getReports(request: TaskReportListRequest): Promise<TaskReport[]> {
    ...
    createReport(report: TaskReport): Promise<TaskReport> {
    ...
    updateReport(report: TaskReport): Promise<TaskReport> {
    ...
    deleteReport(report: TaskReport): Promise<TaskReport> {
