...
var InternService = (function () {
    ...
    InternService.prototype.getTaskHistoryForIntern = function (internId) {
        return this.http.post("/Intern/getTaskHistoryForIntern", JSON.stringify({ internId: internId }), { headers: this.headers }).toPromise()
            .then(function (response) {
            var result = response.json();
            if (result.Error) {
                return Promise.reject(result.Error);
    ...
    InternService.prototype.getReports = function (request) {
        return this.http.post("/Intern/getReports", JSON.stringify(request), { headers: this.headers }).toPromise()
            .then(function (response) {
            var result = response.json();
            if (result.Error) {
                return Promise.reject(result.Error);
    ...
    InternService.prototype.createReport = function (report) {
        return this.http.post("/Intern/createReport", JSON.stringify(report), { headers: this.headers }).toPromise()
            .then(function (response) {
            var result = response.json();
            if (result.Error) {
                return Promise.reject(result.Error);
    ...
    InternService.prototype.updateReport = function (report) {
        return this.http.post("/Intern/updateReport", JSON.stringify(report), { headers: this.headers }).toPromise()
            .then(function (response) {
            var result = response.json();
            if (result.Error) {
                return Promise.reject(result.Error);
    ...
    InternService.prototype.deleteReport = function (report) {
        return this.http.post("/Intern/deleteReport", JSON.stringify(report), { headers: this.headers }).toPromise()
            .then(function (response) {
            var result = response.json();
            if (result.Error) {
                return Promise.reject(result.Error);
