...
var TaskInvolvementHitoryComponent = (function () {
    function TaskInvolvementHitoryComponent(messageService, internService, router, route) {
    ...
    Object.defineProperty(TaskInvolvementHitoryComponent.prototype, "isValid", {
        get: function () {
    ...
    TaskInvolvementHitoryComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    TaskInvolvementHitoryComponent.prototype.ngOnDestroy = function () {
        this.internIdSub.unsubscribe();
    };
    TaskInvolvementHitoryComponent.prototype.handleError = function (error) {
        this.messageService.error(error);
    };
    TaskInvolvementHitoryComponent = __decorate([
        core_1.Component({
            templateUrl: '/app/shared/task-involvement-history.component.html',
            styles: ["\n        .ims-body-container{\n            margin-bottom:0px;\n        }\n\n        .panel-heading{\n                position:relative;\n        }\n\n        .ims-control-container{\n            position:absolute;\n            right:4px;\n            top:4px;\n        }\n\n         .ims-task-control{\n            text-align:left;\n            height:14px;\n            line-height:14px;\n        }\n\n        #ims-description{\n            white-space:pre-line;\n        }\n\n        .ims-inline-title{\n             text-decoration: underline;\n            font-weight:600;\n        }\n\n        .panel-body{\n            padding:1px;\n        }\n\n        .row{\n            margin:0px;\n         }\n        \n        .ims-content-display-area{\n            position:relative;\n            border:1px solid #f1f0fa;\n            margin: 4px 0px;\n            padding: 4px 2px;\n            border-radius:8px;\n\n        }\n       \n        .ims-filter-container{\n            padding: 4px 2px;\n\n        }\n\n"],
            directives: [primeng_1.Column, primeng_1.Button, primeng_1.DataList],
            providers: [],
    ...
    ], TaskInvolvementHitoryComponent);
    return TaskInvolvementHitoryComponent;
}());
exports.TaskInvolvementHitoryComponent = TaskInvolvementHitoryComponent;
//# sourceMappingURL=task-involvement-history.js.map