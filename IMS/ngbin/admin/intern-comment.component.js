...
var supervising_comment_1 = require('./supervising-comment');
...
var InternCommentComponent = (function () {
    function InternCommentComponent(messageService, internService, router, route) {
    ...
    InternCommentComponent.prototype.onSelected = function (comment) {
    ...
    InternCommentComponent.prototype.onUnselected = function (comment) {
    ...
    InternCommentComponent.prototype.delete = function () {
        var _this = this;
        this.internService.deleteComment(this.commentToBeEditted).then(function () {
            for (var i = 0; i < _this.supervisingComments.length; i++) {
                if (_this.supervisingComments[i].Id == _this.commentToBeEditted.Id) {
